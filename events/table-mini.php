...
<div class="tribe-events-widget-nav" >
  <a class="tribe-mini-ajax prev-month" href="#" data-month="<?php echo $tribe_ecp->previousMonth($current_date); ?>"
     title="<?php echo tribe_get_previous_month_text(); ?>" >
  ...
  <a class="tribe-mini-ajax next-month" href="#" data-month="<?php echo $tribe_ecp->nextMonth($current_date); ?>"
     title="<?php echo tribe_get_next_month_text(); ?>" >
...
<a class="tribe-view-all-events"
   href="<?php echo tribe_get_events_link(); ?>" ><?php _e('View all &raquo;', 'tribe-events-calendar'); ?></a >
